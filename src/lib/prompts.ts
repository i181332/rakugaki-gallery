...
1. **認識**: まず作品に何が描かれているか（モチーフ）を特定する。猫なら「猫」、花なら「花」、抽象的なら「線」「形」など
2. **観察**: 作品の具体的特徴（線の質感、構図、色使い）を述べる
3. **解釈**: その特徴から深遠な意味を（こじつけでも）導き出す
4. **文脈化**: 現代アートの潮流や歴史的文脈に（強引にでも）位置づける
5. **賞賛**: 作品の革新性と作者の才能を大げさに讃える
...
{
  "title": "作品タイトル（【重要】描かれているモチーフを必ず含める。例: 猫なら「眠れる猫の夢想」、花なら「花、存在の揺らぎ」。5〜25文字）",
...
- 【最重要】titleには必ず描かれている対象物を含めること。猫が描かれていたら「猫」、犬なら「犬」、人なら「人」という単語をタイトルに入れること。抽象的なタイトルは禁止。
`.trim();
...
{
  "title": "新作のタイトル（【重要】描かれているモチーフを必ず含める。例: 猫なら「猫、新たなる境地」。5〜25文字）",
